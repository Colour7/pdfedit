...
public class PdfSample {
	...
	public static void main(String[] args) throws Exception {
		...
		File file2 = new File("d:/tmp/test-create-water-string.pdf");
		...
		File file3 = new File("d:/tmp/test-create-water-image.pdf");
		...
		//文本替换
		//PdfReplacer textReplacer = new PdfReplacer("E:\\zhujiayi\\34.saas平台产品\\云选房\\版本统计\\V3.2\\东方雨林云选房客户须知20170906(有盖章).pdf");
		PdfReplacer textReplacer = new PdfReplacer("d:\\pdftest\\本机模板2.pdf");
		//textReplacer.replaceText("${first}", "测试公司", 10);
		textReplacer.replaceText("17120401", "测试公司", 10);
		textReplacer.replaceText("17120402", "2017年12月1日", 10);
		textReplacer.replaceText("17120403", "哈哈哈", 10);
		textReplacer.replaceText("17120404", "15757129386", 10);
		textReplacer.replaceText("17120405", "123456789012345678", 10);
		textReplacer.replaceText("17120406", "2017年12月1日", 10);

		textReplacer.toPdf("d:/pdftest/test-replace.pdf");
		...
		pdfSign.init();
		pdfSign.sign(new FileInputStream("d:/tmp/test-create-water-replace.pdf"), new FileOutputStream("d:/tmp/test-create-water-replace-stamp.pdf"), "电子签章例子（仅演示，无法律效率）", "XXX公司", true, 300, 40, 0.5f);
	*/
	}
